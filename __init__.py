...
CLIENT_ID = json.loads(
    open('/var/www/fieldguideApp/FlaskApp/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/fieldguideApp/FlaskApp/client_secrets.json', scope='')
...
def fbconnect():
    ...
    fb_client_secrets = json.loads(open('/var/www/fieldguideApp/FlaskApp/fb_client_secrets.json', 'r').read())
...
if __name__ == '__main__':
    ...
    flask_secret = json.loads(open('/var/www/fieldguideApp/FlaskApp/secrets.json', 'r').read())['flask']
